...
const PageLoader: React.FC<IPageLoaderProps> = () => {
  return (
    <div className={`backdrop-blur-lg absolute content-height w-screen z-50  flex flex-col justify-center items-center`}>
       <div className='continer'>
      <img src="/media/logos/turtlemoveslogo.png" className='absolute h-32 my-11 mx-8' alt="logo" />
